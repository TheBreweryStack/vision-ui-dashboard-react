-- Update get_dashboard_data to prevent duplicate tasks
-- Fix: Exclude note-linked reminders from upcomingReminders (they appear in noteTasks)
-- Fix: Add DISTINCT to note_tasks_pending
...
begin
  ...
  -- FIXED: Only show standalone reminders (not linked to notes) to prevent duplicates
  ...
  -- FIXED: Use DISTINCT to ensure unique tasks
